...
//    private final AppCompatBackgroundHelperoundHelperer mBackgroundTintHelper;
...
//        }
        int id = getId();
        if (id != -1) {
            Log.d("ImageView", "setImageDrawable: " + getResources().getResourceName(id));
            if (drawable instanceof BitmapDrawable) {
                BitmapDrawable bitmapDrawable = (BitmapDrawable) drawable;
                Log.d("ImageView", "memory size: " + bitmapDrawable.getBitmap().getByteCount());
            }
        }
    }
